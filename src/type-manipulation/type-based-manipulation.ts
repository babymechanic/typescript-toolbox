export type UnknownObject = { [K in PropertyKey]: unknown };
export type ExtractByProp<
    TProp extends string,
    TVal extends string,
    TObj extends { [K in TProp]: string }
> = TObj extends { [K in TProp]: TVal } ? TObj : never;
type Merge<T extends UnknownObject, U extends UnknownObject> = {
...
export type PartialExcept<T extends UnknownObject, TRequired extends keyof T> = Merge<{
...
export type AddProp<TObj, TProp extends PropertyKey, TVal> = TObj extends UnknownObject ? {
